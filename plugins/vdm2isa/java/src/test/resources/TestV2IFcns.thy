(* VDM to Isabelle Translation @2022-03-18T14:10:47.657780Z
   Copyright 2021, Leo Freitas, leo.freitas@newcastle.ac.uk

in 'plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl' at line 1:8
files = [plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl]
*)
theory TestV2IFcns
imports "VDMToolkit" 
begin
...
\<comment>\<open>VDM source: const: (() -> nat)
	const() ==
10\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 7:5\<close>
...
10
	pre (10 > 5)
	post (RESULT > 0)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 11:5\<close>

\<comment>\<open>VDM source: pre_constS: (() +> bool)
	pre_constS() ==
(10 > 5)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 13:12\<close>
definition
	pre_constS :: "bool"
where
	"pre_constS  \<equiv> 
...
\<comment>\<open>VDM source: post_constS: (nat +> bool)
	post_constS(RESULT) ==
(RESULT > 0)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 14:17\<close>
definition
...
\<comment>\<open>VDM source: f: (nat * nat1 -> nat1)
	f(x, y) ==
(x + y)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 17:5\<close>
...
(x + y)
	pre ((x > 10) and (y > 20))
	post (x < RESULT)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 21:5\<close>

\<comment>\<open>VDM source: pre_g: (nat * nat1 +> bool)
	pre_g(x, y) ==
((x > 10) and (y > 20))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 23:16\<close>
definition
...
\<comment>\<open>VDM source: post_g: (nat * nat1 * nat1 +> bool)
	post_g(x, y, RESULT) ==
(x < RESULT)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 24:12\<close>
definition
...
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 27:5\<close>

\<comment>\<open>VDM source: pre_h: (nat +> bool)
	pre_h(x) ==
(pre_g(x, x) and (x < 20))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 29:21\<close>
definition
...
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 30:31\<close>
definition
...
g(x, x)
	pre (x < 20)
	post (x > 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 33:5\<close>

\<comment>\<open>VDM source: pre_h': (nat +> bool)
	pre_h'(x) ==
(x < 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 35:11\<close>
definition
	pre_h' :: "VDMNat \<Rightarrow> bool"
where
	"pre_h' x \<equiv> 
...
\<comment>\<open>VDM source: post_h': (nat * nat +> bool)
	post_h'(x, RESULT) ==
(x > 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 36:12\<close>
definition
	post_h' :: "VDMNat \<Rightarrow> VDMNat \<Rightarrow> bool"
where
	"post_h' x   RESULT \<equiv> 
...
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 39:5\<close>

\<comment>\<open>VDM source: pre_h'': (nat +> bool)
	pre_h''(x) ==
(x < 20)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 41:11\<close>
definition
	pre_h'' :: "VDMNat \<Rightarrow> bool"
where
	"pre_h'' x \<equiv> 
...
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 42:26\<close>
definition
	post_h'' :: "VDMNat \<Rightarrow> VDMNat \<Rightarrow> bool"
where
	"post_h'' x   RESULT \<equiv> 
...
\<comment>\<open>VDM source: curried: (nat -> (nat -> nat))
	curried(x)(y) ==
(x + y)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 45:5\<close>
...
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 49:5\<close>

\<comment>\<open>VDM source: pre_curriedS: (nat +> (nat +> bool))
	pre_curriedS(x)(y) ==
(x > y)\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 51:11\<close>
definition
...
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 52:21\<close>
definition
...
\<comment>\<open>VDM source: static private implicit((x, y:nat), (z:set of (nat)))r:seq of (nat)
	...
	post (x > (len r))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 54:5\<close>

\<comment>\<open>VDM source: pre_implicit: (nat * nat * set of (nat) +> bool)
	pre_implicit(x, y, z) ==
((x < y) and (x in set z))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 55:15\<close>
definition
...
(x > (len r))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 56:12\<close>
definition
...
\<comment>\<open>VDM source: static private implicitexplicit((x, y:nat), (z:set of (nat)))r:seq of (nat) ==
	...
	pre ((x < y) and (x in set z))
	post (x > (len r))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 58:5\<close>

\<comment>\<open>VDM source: pre_implicitexplicit: (nat * nat * set of (nat) +> bool)
	pre_implicitexplicit(x, y, z) ==
((x < y) and (x in set z))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 60:15\<close>
definition
...
(x > (len r))\<close>
\<comment>\<open>in 'TestV2IFcns' (plugins/vdm2isa/java/src/test/resources/TestV2IFcns.vdmsl) at line 61:12\<close>
definition
